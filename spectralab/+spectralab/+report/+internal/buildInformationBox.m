...
required = ["Archive","Measurement","Metadata","Instrument","Analysis","Result","Report"];
...
metadataRows = [ ...
    makeRow("Measurement", firstValue(context, ["Measurement.Name"]))
    makeRow("Project", firstValue(context, ["Measurement.Project","Metadata.Project"]))
    makeRow("Sample", firstValue(context, ["Measurement.Sample","Metadata.Sample"]))
    makeRow("Operator", firstValue(context, ["Measurement.Operator","Metadata.Operator"]))
    makeRow("Date", firstValue(context, ["Measurement.Date","Measurement.MeasurementDate","Metadata.Date"]))
    makeRow("Instrument", firstValue(context, ["Instrument.Name","Instrument.Model","Instrument.Instrument"]))
