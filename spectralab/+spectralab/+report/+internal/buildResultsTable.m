...
for k = 1:numel(fields)
    ...
    [displayLabel, labelLines] = ...
        spectralab.report.internal.wrapValue(definition.Label, 28);
    [displayText, valueLines] = ...
        spectralab.report.internal.wrapValue(displayText, 36);
