...
result=spectralab.release.verifyIdentity(ExpectedVersion="1.1.1-dev");
verifyEqual(testCase,result.Status,"PASS");
verifyEqual(testCase,result.ExpectedTag,"v1.1.1-dev");
...
verifyError(testCase,@() spectralab.release.verifyIdentity( ...
    ExpectedTag="v1.1.2"),"SpectraLab:Release:TagVersionMismatch");
end
