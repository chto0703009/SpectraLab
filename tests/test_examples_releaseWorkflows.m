...
verifyTrue(testCase, contains(criSource, ...
    "companion standalone PNG adds spectral results"), ...
    "The CRI example must distinguish the clean PDF figure from its detailed PNG.");
verifyTrue(testCase, contains(criSource, "ShowFigure=false"), ...
    "CRI generation must not display the internal PDF figure as a second plot.");
