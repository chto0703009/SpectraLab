...
verifyEqual(testCase, analysis.Result.RMSDifference, sqrt(2/3), ...
    AbsTol=1e-12);
verifyEqual(testCase, analysis.Result.RMSDifferencePercent, ...
    100 * sqrt(2/3) / sqrt(mean([2; 5; 8].^2)), AbsTol=1e-12);
