...
verifyEqual(testCase, style.Appearance.BoxBorderColor, [0.40 0.40 0.40]);
verifyEqual(testCase, style.Appearance.BoxBorderLineWidth, 0.50);
...
verifyEqual(testCase, style.ResultsTable.VerticalGap, 32);
verifyEqual(testCase, style.ResultsTable.RowHeight, 18);
verifyEqual(testCase, style.ResultsTable.SpaceAfter, 8);
verifyEqual(testCase, style.InformationBox.VerticalGap, 12);
...
verifyEqual(testCase, style.Figure.BottomPadding, 46);
verifyEqual(testCase, style.Figure.TopPadding, 30);
